  ...
  <script type="text/javascript">
    $(function () {
        ...
        onComplete: function(swaggerApi, swaggerUi){
          if(typeof initOAuth == "function") {
            initOAuth({
              ...
              realm: "your-realms",
              appName: "KSHRD CENTER MANAGEMENT", 
              scopeSeparator: ",",
      ...
      function addApiKeyAuthorization(){
        ...
        if(key && key.trim() != "") {
            var apiKeyAuth = new SwaggerClient.ApiKeyAuthorization("Authorization", "Basic aHJkOiFAI2hyZGFwaQ==", "header");
...
<div id='header'>
  <div class="swagger-ui-wrap">
    <a id="logo" href="http://swagger.io">SR GROUP ONE</a>
    <form id='api_selector'>
      ...
      <div class='input'><input placeholder="api_key" value="Basic aHJkOiFAI2hyZGFwaQ==" id="input_apiKey" name="apiKey" type="hidden"/></div>
